...
//!
//! `deploy/kickoff-channel-app.service` carried `IPAddressDeny=any` under a comment saying that line was
...
//! kickoff-channel.service, an address-family line headed "Loopback TCP only" as though a family list
