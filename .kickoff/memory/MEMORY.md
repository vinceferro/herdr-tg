...
- [Cargo needs a real TMPDIR](cargo-needs-a-real-tmpdir.md) — seven transport tests and every commit fail for a fake reason without the override.
- [herdr reports no structured ask](herdr-reports-no-structured-ask.md) — why answering a pane from its pixels is ill-posed, not merely hard.
- [A fix nobody attacked is a draft](a-fix-nobody-attacked-is-a-draft.md) — five rounds, every one green on all five gates before a sceptic broke it.
